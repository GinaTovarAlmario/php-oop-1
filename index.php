...
<body class="bg-dark">
    <main class="container">
        <h1 class="text-center mt-3 text-success">Movie List</h1>
        <div class="row">
            <?php foreach($movies as $movie) { ?>
                <div class="col-4 mb-3">
                    <div class="card mt-3 text-dark bg-secondary-subtle" style="width: 300px; height:550px;">
                        <img src="<?= $movie->cover;?>" style="width: 300px; height: 370px;">
                        <div class="card-body">
                            <h5 class="card-title">
                                Titolo: <?= $movie->title; ?>
                            </h5>
